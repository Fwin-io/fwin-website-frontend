               ...
               <div class="h-full p-8 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                  <ul class="space-y-2 font-medium flex flex-col h-full">
                     ...
                     <li onClick={() => this.handleSelectGame('coinflip')}>
                        <a href="#" class={`flex items-center p-2 text-gray-900  rounded-lg group ${selectedGame === "coinflip" ? 'bg-black text-white' : ''}`}>
                     ...
                     <li onClick={() => this.handleSelectGame('crash')}>
                        <a href="#" class={`flex items-center p-2 text-gray-900  rounded-lg group ${selectedGame === "crash" ? 'bg-black text-white' : ''}`}>
                     ...
                     <li onClick={() => this.handleSelectGame('dice')}>
                        <a href="#" class={`flex items-center p-2 text-gray-900  rounded-lg group ${selectedGame === "dice" ? 'bg-black text-white' : ''}`}>
                     ...
                     <li onClick={() => this.handleSelectGame('roulette')}>
                        <a href="#" class={`flex items-center p-2 text-gray-900  rounded-lg group ${selectedGame === "roulette" ? 'bg-black text-white' : ''}`}>
                     ...
                     <li onClick={() => this.handleSelectGame('slots')}>
                        <a href="#" class={`flex items-center p-2 text-gray-900  rounded-lg group ${selectedGame === "slots" ? 'bg-black text-white' : ''}`}>
