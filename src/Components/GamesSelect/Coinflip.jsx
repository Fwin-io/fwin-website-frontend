...
import Headtails from './Coinflip/Headtails';
                ...
                <div className='flex-1 overflow-y-auto overflow-x-hidden bg-background'>
                    <main className=''>
                        <div className='space-y-5'>
                            {/* Title Section*/}
                            <div class="flex items-center gap-2 text-poly-yellow"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"><rect width="24" height="24" fill="#FFDB5B" rx="6"></rect><path fill="#3D2F00" fill-rule="evenodd" d="M17.8434 4.14129C17.1126 3.41053 16.1215 3 15.088 3H8.91195c-1.03344 0-2.02456.41053-2.75532 1.14129L4.14129 6.15663C3.41054 6.88739 3 7.87851 3 8.91195V15.088c0 1.0335.41053 2.0246 1.14129 2.7554l2.01534 2.0153C6.88739 20.5895 7.87851 21 8.91195 21H15.088c1.0335 0 2.0246-.4105 2.7554-1.1413l2.0153-2.0153C20.5895 17.1126 21 16.1215 21 15.088V8.91195c0-1.03344-.4105-2.02456-1.1413-2.75532l-2.0153-2.01534ZM6.49911 10.6277c-.76086.7608-.76086 1.9944 0 2.7553l4.13299 4.133c.7609.7608 1.9945.7608 2.7553 0l4.133-4.133c.7609-.7609.7609-1.9945 0-2.7553l-4.133-4.13303c-.7608-.76086-1.9944-.76086-2.7553 0L6.49911 10.6277Z" clip-rule="evenodd"></path></svg><h3>Coinflip</h3>
                            </div>
                            {/* Game Section*/}
                            <section >
                                    ...
                                    <form>
                                        <div className='flex flex-col sm:flex-row'>
                                            ...
                                            <div className='${breakpoint}:flex ${breakpoint}:flex-col grid grid-cols-2 gap-4 p-4 sm:flex sm:flex-col'>
                                                ...
                                                <div className='space-y-2 max-w-52'>
                                                    <label class="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex gap-1 text-base" for=":r7a:-form-item">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-coins rounded-lg border bg-background stroke-foreground p-1"><circle cx="8" cy="8" r="6"></circle><path d="M18.09 10.37A6 6 0 1 1 10.34 18"></path><path d="M7 6h1v4"></path><path d="m16.71 13.88.7.71-2.82 2.82"></path></svg>
                                                        Coins</label>
                                                    <div role="radiogroup" aria-required="false" dir="ltr" class="flex justify-between gap-1" tabindex="0" >
                                                        <div class="space-y-2">
                                                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 [&amp;:has([data-state=checked])>div]:border-foreground [&amp;:has([data-state=checked])>div]:bg-foreground [&amp;:has([data-state=checked])>div]:text-background" for=":r7b:-form-item">
                                                                ...
                                                                <div className={`cursor-pointer rounded-lg border border-border px-2 py-1 hover:bg-border sm:px-3 ${selectedNumber === 1 ? 'bg-black text-white' : ''}`}>
                                                        ...
                                                        <div class="space-y-2">
                                                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 [&amp;:has([data-state=checked])>div]:border-foreground [&amp;:has([data-state=checked])>div]:bg-foreground [&amp;:has([data-state=checked])>div]:text-background" for=":r7d:-form-item">
                                                                <button onClick={() => this.handleNumberChange(2)} type="button" role="radio" aria-checked="false" data-state="unchecked" value="2" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 sr-only" id=":r7d:-form-item" aria-describedby=":r7d:-form-item-description" aria-invalid="false" tabindex="-1" data-radix-collection-item="">
                                                                    ...
                                                                    <div className={`cursor-pointer rounded-lg border border-border px-2 py-1 hover:bg-border sm:px-3 ${selectedNumber === 2 ? 'bg-black text-white' : ''}`}>
                                                                        <h3 class="text-center text-xl">2</h3>
                                                                    </div>
                                                            </label>
                                                        </div>
                                                        <div class="space-y-2">
                                                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 [&amp;:has([data-state=checked])>div]:border-foreground [&amp;:has([data-state=checked])>div]:bg-foreground [&amp;:has([data-state=checked])>div]:text-background" for=":r7f:-form-item">
                                                                ...
                                                                <div className={`cursor-pointer rounded-lg border border-border px-2 py-1 hover:bg-border sm:px-3 ${selectedNumber === 3 ? 'bg-black text-white' : ''}`}>
                                                                    <h3 class="text-center text-xl">3</h3>
                                                                </div>
                                                            </label>
                                                        </div>
                                                        <div class="space-y-2">
                                                            <label class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 [&amp;:has([data-state=checked])>div]:border-foreground [&amp;:has([data-state=checked])>div]:bg-foreground [&amp;:has([data-state=checked])>div]:text-background" for=":r7h:-form-item">
                                                                <button onClick={() => this.handleNumberChange(4)} type="button" role="radio" aria-checked="true" data-state="checked" value="4" class="aspect-square h-4 w-4 rounded-full border border-primary text-primary ring-offset-background focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 sr-only" id=":r7h:-form-item" aria-describedby=":r7h:-form-item-description" aria-invalid="false" tabindex="0" data-radix-collection-item="">
                                                                    ...
                                                                    <div className={`cursor-pointer rounded-lg border border-border px-2 py-1 hover:bg-border sm:px-3 ${selectedNumber === 4 ? 'bg-black text-white' : ''}`}>
                                                                        <h3 class="text-center text-xl">4</h3>
                                                                    </div>
                                                            </label>
                                                        </div>
                                                        </div>
                                            ...
                                            <div class="flex w-full flex-col justify-between gap-8 border-t p-4 sm:border-l sm:border-t-0">
                                                <Headtails selectedNumber={selectedNumber} />
